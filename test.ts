...
Deno.test("[constructor] should works with 2 BigInts", () => {
...
Deno.test("[constructor] should works with string", () => {
...
Deno.test("[constructor] should works with two strings", () => {
  assertEquals(Rat("2", "3"), Rat(2n, 3n));
});

Deno.test("[constructor] should works with Rat", () => {
